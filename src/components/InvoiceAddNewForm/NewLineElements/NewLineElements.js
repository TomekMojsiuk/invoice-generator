...
class NewLineElements extends React.Component {
  ...
  render() {
    const selectedProduct = this.props.products.find(
      (product) => product.id === this.props.line.productId,
    );
    const grossAmount = selectedProduct
      ? (selectedProduct.vat / 100) *
    ...
    return (
      <div className={'new--line--container'}>
        ...
        <div className={'form--input'}>
          <input name="productPrice" type="text" value={1} />
        </div>
        ...
        <div className={'form--input'}>
          <select
            onChange={(e) =>
              this.productOnChange(this.props.line.id, e.target.value)
            }
        ...
        <div className={'form--input'}>
          <input
            ...
            onChange={(e) =>
              this.productQuantityOnChange(this.props.line.id, +e.target.value)
            }
          />
        </div>
