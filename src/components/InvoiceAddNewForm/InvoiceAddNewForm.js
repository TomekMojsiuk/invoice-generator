				...
				<form>
					...
					<div className={'form--section invoice'}>
						...
						<div className={'form--input'}>
							...
							<input name="issueDate" type={this.state.issueDateFieldType} onFocus={this.handleDateFieldTypeOnFocus} placeholder="Podaj datę wystawienia faktury"/>
						</div>

						<div className={'form--input'}>
							<label>Data płatności:</label>
							<input name="dueDate" type={this.state.dueDateFieldType} onFocus={this.handleDateFieldTypeOnFocus} placeholder="Wprowadź datę płatności"/>
						</div>
					...
					<div className={'form--section invoice'}><h2 className={"form--section--title"}>Linia kosztowa</h2></div>
